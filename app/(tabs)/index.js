...
export default function DashboardScreen() {
  ...
  async function shareBookingPage() {
    const url = `https://vimen.app/b/${profile?.booking_slug || "yourname"}`;
      ...
      <ScrollView
        ...
        <TouchableOpacity onPress={() => router.push("/(screens)/booking")}
          ...
          <View style={{ flex:1 }}>
            ...
            <Text style={{ fontSize:12, color:"rgba(255,255,255,0.4)" }} numberOfLines={1}>vimen.app/b/{profile?.booking_slug || "yourname"}</Text>
          </View>
