...
export default {
  ...
  jobs: {
    ...
    invoiceAutoCreateFailedToast: "Chantier terminé, mais la facture n'a pas pu être créée automatiquement — ajoute-la manuellement.",
    invoiceAutoCreatedToast: "Facture créée automatiquement",
    updateFailed: "Impossible de modifier ce chantier."
  },
  quotes: {
    title: "Devis",
    new: "+ Nouveau devis",
    ...
    screen: {
      ...
      alerts: {
        ...
        errorConverting: "Impossible de créer le chantier. Réessaie."
      }
    },
    emailFailedTitle: "Échec de l'envoi",
    emailShort: "Email",
    emailedSentTo: "Devis envoyé à {{email}}",
    emailedTitle: "Envoyé !",
    fields: {
      vatRate: "Taux de TVA (%)"
    },
  ...
  invoices: {
    ...
    createPaymentLink: "Lien de paiement",
    delete: "Supprimer",
    deleteConfirmMessage: "Cette action est irréversible.",
    deleteConfirmTitle: "Supprimer cette facture ?",
    deleteFailed: "Impossible de supprimer cette facture.",
    holdToCopyId: "Rester appuyé pour copier l'ID",
    paymentLinkCreated: "Lien de paiement créé",
    paymentLinkFailed: "Échec de la création du lien de paiement. Vérifie ta connexion Stripe.",
    referenceLabel: "Référence :",
    sortCodeLabel: "Code guichet :",
    updateFailed: "Impossible de modifier cette facture."
  },
  clients: {
    title: "Clients",
    new: "+ Nouveau client",
    ...
    upgradeMessage: "Le plan gratuit est limité à 5 clients. Passe Pro pour un nombre illimité de clients.",
    upgradeTitle: "Limite de clients atteinte"
  },
  booking: {
    title: "Réservations",
    requests: "Demandes",
    ...
    availabilitySaveFailed: "Impossible d'enregistrer les disponibilités, réessaie",
    availabilitySaved: "Disponibilités enregistrées",
    availabilitySubtitle: "Définis les jours et horaires où les clients peuvent te réserver.",
  ...
  payments: {
    ...
    overview: {
      ...
      connectedBanner: "Stripe connecté — tu peux accepter les paiements par carte.",
      notConnectedDesc: "Connecte ton compte bancaire pour commencer à accepter les paiements en ligne de tes clients.",
    ...
    connect: {
      ...
      connectedBody: "Tes virements sont gérés via Stripe. Tu peux modifier tes coordonnées bancaires et consulter le détail des frais directement sur ton tableau de bord Stripe.",
      connectedDesc: "Ton compte est connecté et prêt à traiter des paiements.",
      notConnectedBody: "Connecte ton compte Stripe pour commencer à accepter les paiements par carte de tes clients.",
      notConnectedDesc: "Connecte-toi pour commencer à accepter les paiements par carte.",
      syncBtn: "Synchroniser",
      syncSuccess: "Synchronisation effectuée",
      noCommissionNote: "Vimen ne prélève aucune commission pour l'instant — tu ne paies que les frais de traitement standard de Stripe."
    },
  ...
  marketplace: {
    ...
    postFailed: "Impossible de publier ton annonce.",
    ...
    delete: "Supprimer",
    deleteConfirmMessage: "Cette action est irréversible.",
    deleteConfirmTitle: "Supprimer cette annonce ?",
    employeesLabel: "Employés",
    experienceLabel: "Expérience requise",
    loadMore: "Charger plus",
    markUrgent: "Marquer comme urgent",
    noneMine: "Tu n'as encore rien publié.",
    quantityLabel: "Quantité",
    reopen: "Rouvrir",
    searchPlaceholder: "Rechercher des annonces...",
    stats: {
      activeDemands: "Demandes",
      businessesForSale: "À vendre",
      materialsForSale: "Matériaux",
      recruitmentPosts: "Recrutements"
    },
    tabMaterials: "Matériaux",
    typeMaterials: "Matériaux",
    viewBrowse: "Parcourir",
    viewMine: "Mes annonces",
    workStartLabel: "Date de début souhaitée",
    loadErrorWhat: "Échec du chargement des annonces",
    toast: {
      requiredContact: "L'email de contact est requis."
    }
  },
  reviews: {
    title: "Avis",
    ...
    addFailedTitle: "Impossible d'ajouter cet avis. Réessaie.",
    noClientPhone: "Ce client n'a pas de numéro de téléphone.",
    requestFailedTitle: "Impossible d'envoyer la demande",
    saving: "Enregistrement...",
    sending: "Envoi..."
  },
  certifications: {
  ...
  referrals: {
    ...
    screen: {
      ...
      howItWorks: {
        ...
        step1: {
          title: "Partagez",
          desc: "Envoyez votre lien à un artisan que vous connaissez."
        },
        step2: {
          title: "Il s'inscrit",
          desc: "Il crée un compte gratuit en utilisant votre lien."
        },
        step3: {
        ...
        step4: {
          ...
          desc: "Appliqué automatiquement aux deux comptes."
        }
      },
      ...
      plans: {
        free: {
          ...
          features: {
            "0": "5 clients",
            "1": "10 factures/mois",
            "2": "Page de réservation (avec marque)"
          }
        },
        pro: {
          name: "Pro",
  ...
  more: {
    ...
    items: {
      ...
      marketplace: {
        ...
        desc: "Demandes, fonds de commerce, recrutement"
      },
      reviews: {
        label: "Avis",
        desc: "Demandez et gérez les avis clients"
      },
      referrals: {
        label: "Parrainage",
        desc: "Parrainez un artisan, obtenez 2 mois offerts"
      },
      booking: {
        label: "Page de réservation",
        desc: "Gérez votre page de réservation publique"
      },
      certifications: {
        label: "Certifications",
        desc: "Suivez vos certifications et dates d'expiration"
      }
    },
    signOut: {
